...
angular.module('Brick').controller('BlockchainsController', ['$http', '$log', '$scope', '$location',
    function($http, $log, $scope, $location) {
        ...
        this.groups = function(){
            ...
            var url = "http://localhost:5000/Brick/blockchains";
            ...
            $log.error("Blockchains Loaded: ", JSON.stringify(thisCtrl.groupList));
        };
